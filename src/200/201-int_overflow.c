...
// TO DO 5 (optional): Use this program as benchmark for your CPU performance
// and compare it with other students' computers, TO DO 6 (optional): Check the
// CPU load when running the programm. What do you observe?
...
int main() {
  ...
  while (1) {   // repeat the following code in { .... } endless
    ...
    if (old_c >
        c) {  // execute the following code in { ... } if condition is true
