...
// TO DO 4: DONE!!! Write functions addStudent(), for adding a student at the end of the array, and printAllStudents() for printing all students stored.
// TO DO 5: DONE!!! Write a function menu(), which allows the user to select one of the actions
//            - add Student
//            - print all students
//            - quit program
// TO DO 6: DONE!!! Extend the student data and the corresponding functions with the gender male/female (using "enum").
// TO DO 7: DONE!!! Create a structure for handling dates (day, month, year) and use it for birth date, date of enrollment etc.
// TO DO 8: DONE!!! Extend the program such it also handles address information (street, number, zip-code and city).
// TO DO 9: DONE!!! optional: Add a function and menu item for deleting a selected student.
...
void addStudent(int *numberStudents) {
    ...
    while (1) {
        ...
        if (sscanf(dateInput, "%d %d %d", &students[*numberStudents].birth_date.day, &students[*numberStudents].birth_date.month, &students[*numberStudents].birth_date.year) == 3) {
            break;
        } else {
    ...
    while (1) {
        ...
        fgets(dateInput, sizeof(dateInput), stdin);
        if (sscanf(dateInput, "%d %d %d", &students[*numberStudents].enrollment_date.day, &students[*numberStudents].enrollment_date.month, &students[*numberStudents].enrollment_date.year) == 3) {
            break;
        } else {
            printf("Invalid date format. Please enter the date in the format (dd mm yyyy).\n");
        }
    ...
    printf("Enter street: ");
    fgets(students[*numberStudents].address.street, sizeof(students[*numberStudents].address.street), stdin);
    students[*numberStudents].address.street[strcspn(students[*numberStudents].address.street, "\n")] = '\0'; // Remove newline character
    ...
    printf("Enter city: ");
    fgets(students[*numberStudents].address.city, sizeof(students[*numberStudents].address.city), stdin);
    students[*numberStudents].address.city[strcspn(students[*numberStudents].address.city, "\n")] = '\0'; // Remove newline character
...
void display(int numberStudents) {
    printf("%-4s %-15s %-15s %-10s %-10s %10s %18s %-10s %-9s %-14s\n", "No.", "Last Name:", "First Name:", "Gender:", "Birth Date:", "Enroll Date:", "Street:", "Number:", "Zip Code:", "City:");
    for (int i = 0; i < numberStudents; i++) {
        ...
        printf("%-4d %-15s %-15s %-10s %02d/%02d/%04d  %02d/%02d/%04d %20s %-8d %10d, %-15s\n",
               i + 1,
...
void initializeTestData(int *numberStudents) {
    ...
    strcpy(students[*numberStudents].first_name, "Til");
    strcpy(students[*numberStudents].last_name, "Meinel");
    students[*numberStudents].gender = MALE;
    ...
    strcpy(students[*numberStudents].first_name, "Rea");
    strcpy(students[*numberStudents].last_name, "Naomi");
    students[*numberStudents].gender = FEMALE;
    ...
    strcpy(students[*numberStudents].first_name, "Marius");
    strcpy(students[*numberStudents].last_name, "Meier");
    students[*numberStudents].gender = MALE;
